...
$this->setProperty('nightBrightnessLevel', '10');
$this->setProperty('nightColorLevel', '100');
$this->setProperty('dayBrightnessLevel', '100');
$this->setProperty('dayColorLevel', '0');
...
$this->setProperty('colorWorkMax', '370');
$this->setProperty('colorWorkMin', '153');
